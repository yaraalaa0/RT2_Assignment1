...
#from rt2_assignment1_1.srv import Position
import math
...
## The callback function of the action server
## takes as input the goal position
def execute_action(goal):
    ...
    while True:
        ...
        if action_service.is_preempt_requested():
            #print("Action: /go_to_point_ac is preempted\n")
...
def main():
    ...
    ## The action server definition and start
